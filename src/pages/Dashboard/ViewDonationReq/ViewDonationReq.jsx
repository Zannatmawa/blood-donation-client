...
const ViewDonationReq = () => {
    ...
    return (
        <div className="min-h-screen bg-red-50 py-16 px-4">
            {pendingReq.map(req => <div className="max-w-3xl mx-auto bg-white rounded-xl shadow-lg p-8">
                ...
                <div className="flex justify-between">
                    ...
                    <dialog id="my_modal_1" className="modal">
                        <div className="modal-box">
                            <form method="dialog">
                                <div className="mb-5">
                                    <label class="text-gray-700 font-medium">Donor Name:</label>
                                ...
                                <div className="mb-5">
                                    <label class="text-gray-700 font-medium">Donor Email:</label>
